...
inline unsigned short CConfig::GetUnstAdj_tempcoarse(void) {return tempcoarse;}
...
inline unsigned long CConfig::GetnNonUniformTS(void) { return nNonUniformTS; }
inline su2double CConfig::Get_iNonUniform_timestps_ND(unsigned long iter) {return NonUniform_timestps_ND[iter];}

inline bool CConfig::GetNonUniformTimeStepping(void) {return NonUniform_TimeStepping;}

inline su2double CConfig::Get_iDiscAdjNonUniform_timestps_ND(unsigned long iter) {return DiscAdjNonUniform_timestps_ND[iter];}
...
inline void CConfig::SetDelta_UnstTime(su2double val_delta_unsttime) { Delta_UnstTime = val_delta_unsttime; }
